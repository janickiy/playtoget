          ...
          <div class='job_form'>
            <form class="form-horizontal">
              <div class="form-group">
                <div id="container" class='marginTop20'> <a id="pickfiles" href="javascript:;" class='save-button center_text'>${BUTTON_ADD_FILES}</a> <a id="uploadfiles" href="javascript:;" class='save-button'>${BUTTON_DOWNLOAD_FILES}</a> </div>
              </div>
            </form>
          </div>
	...
	uploader.removeFile(num);
          ...
          <div  class="photo-container pop-photos">
            ...
            <div class="hov" id="photo-block-${ID_PHOTO}"> <a class='photo_big' title="${DESCRIPTION}" href="${BIG_IMAGE}" data-lightbox="roadtrip" data-num='${ID_PHOTO}'> <img src="${SMALL_IMAGE}" alt="">
              ...
              </a> <span class="icons-hid"> <span class="icons-hid"><i id="my-video-${ID_PHOTO}" class="remove_pic" id="${ID_PHOTO}" data-item="${ID_PHOTO}" data-tooltip="${STR_REMOVE_PHOTO}"><img src="./templates/images/icon-krest.png" alt=""></i></span> </span> </div>
            <!-- END IF -->
            <!-- END row_photos_list -->
          </div>
          <!-- END IF -->
          ...
          <div class="event-container">
            ...
            <div class="event-item"> <a href="./?task=fitness&id_sport_block=${ID}" class="img">
              <!-- IF '${AVATAR}' !='' -->
              <img src="${AVATAR}"></a>
              <!-- END IF -->
              <div class="teg">
                ...
                <p>${PLACE}</p>
                <p>${ABOUT}</p>
                <a href="./?task=fitness&id_sport_block=${ID}&q=edit">${STR_EDIT}</a></div>
            </div>
